        ...
        public Bootstrap3()
        {
            ...
            Rules = new List<IRule<HtmlElementTypes>>
            {
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Input } } },
                ...
                {
                    Description = "Button",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Button, HtmlElementTypes.A, HtmlElementTypes.Input } } },
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Div } } },
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="#">Dropdown link</a></li>
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Ul } } },
                ...
                {
                    Description = "TabItem",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Li } } },
                ...
                {
                    Description = "NavBar",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Nav } } },
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Form } } },
                ...
                {
                    Description = "Label",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Label } } },
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.A } } },
                    TargetType = JdiElementTypes.ListItem,
                    OrConditions = new List<IRuleCondition>
                    { new RuleCondition { Relationship = NodeRelationships.Self, Marker = Markers.Class, MarkerValues = new List<string> { "list-group-item" } } }
                },
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Button } } },
                    TargetType = JdiElementTypes.ListItem,
                    OrConditions = new List<IRuleCondition>
                    { new RuleCondition { Relationship = NodeRelationships.Self, Marker = Markers.Class, MarkerValues = new List<string> { "list-group-item" } } }
                },
                ...
                {
                    Description = "Table",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Table } } },
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>>(),
                    TargetType = JdiElementTypes.Table,
                    OrConditions = new List<IRuleCondition>
                    { new RuleCondition { Relationship = NodeRelationships.Self, Marker = Markers.Class, MarkerValues = new List<string> { "table" } } }
                },
                ...
                {
                    Description = "Label",
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.Span } } },
                    TargetType = JdiElementTypes.Label,
                    OrConditions = new List<IRuleCondition>
                ...
                new Rule<HtmlElementTypes>
                {
                    ...
                    SourceTypes = new List<ISourceElementTypeCollection<HtmlElementTypes>> { new SourceElementTypeCollection<HtmlElementTypes> { Types = new List<HtmlElementTypes> { HtmlElementTypes.P } } },
                    TargetType = JdiElementTypes.Text,
                    OrConditions = new List<IRuleCondition>
